-- FINAL CLIENT SCRIPT WITH CENTERED UI
...
print("Final VotingNPCClient script starting...")
...
-- Create a voting UI with current vote highlighted - CENTERED ON SCREEN
...
-- Create cooldown notification - CENTERED
local function createCooldownNotification(remainingTime)
    ...
    notifFrame.Position = UDim2.new(0.5, 0, 0.5, 0) -- Centered
    notifFrame.AnchorPoint = Vector2.new(0.5, 0.5) -- Anchor at center
