--[[
VOTING NPC WITH E KEY INTERACTION
...
- "E" key interaction with ProximityPrompt instead of clicking
...
print("=== Voting NPC with E Key Interaction Starting ===")
...
-- Update the text on the vote display (declaration before use)
local function updateVoteText(textLabel)
...
local function setupProximityPrompt()
    ...
    proximityPrompt.ObjectText = "רעיון חדש למשחק" -- Idea title
...
local function initializeVotingSystem()
    ...
    print("=== Voting NPC Initialized with E Key Interaction ===")
end
